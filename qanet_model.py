...
class QANet(nn.Module):
    ...
    def __init__(self, word_vectors, hidden_size, char_vocab_size , char_emb_size, word_char_emb_size,  drop_prob,
        ...
        self.emb_enc = layers1.Embedding_Encoder( self.num_blocks_embd,
                                                 self.num_conv_embd,
                                                 self.kernel_size,
                                                 self.hidden_size,
                                                 self.num_heads,
        ...
        self.att = layers1.BiDAFAttention(hidden_size= self.hidden_size)
        ...
        self.mod = layers1.Model_Encoder(self.num_blocks_model, 
                                        self.num_conv_model, 
                                        self.kernel_size, 
                                        self.hidden_size, 
                                        self.num_heads, 
        ...
        self.out = layers1.output_layer(self.hidden_size)
    ...
    def forward(self, cw_idxs, qw_idxs, cc_idxs, qc_idxs):
        ...
        #print(torch.mean(c_enc))
        #print('c_enc is', c_enc[0:5])
        #Dropout 
